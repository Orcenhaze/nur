...
pushd ..\build
cl %COMPILER_FLAGS% /I..\src\vendor ..\src\win32_main.cpp -Fmwin32_main.map /link /MANIFEST:EMBED /MANIFESTINPUT:nur.manifest /entry:WinMainCRTStartup /subsystem:windows %LINKER_FLAGS% 
popd
popd
